...
class DefaultRefreshModule(context: Context) : BaseRefreshModule(context) {
    ...
    private var circularProgressDrawable: com.qiniu.qbaseframe.refresh.CircularProgressDrawable
    private var mCircleView: com.qiniu.qbaseframe.refresh.CircleImageView
    ...
    init {
        ...
        mCircleView = com.qiniu.qbaseframe.refresh.CircleImageView(context, CIRCLE_BG_LIGHT)
        circularProgressDrawable = com.qiniu.qbaseframe.refresh.CircularProgressDrawable(context)
        ...
        circularProgressDrawable.setStyle(com.qiniu.qbaseframe.refresh.CircularProgressDrawable.DEFAULT)
        // 设置环形的宽度
