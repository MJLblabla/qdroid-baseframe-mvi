...
import com.qiniu.qbaseframe.R
import kotlin.math.abs

class DefaultLoadModule(context: Context) : BaseLoadModule(context) {
    var noMoreText = context.getText(R.string.no_more_tips)
    private val mCircleImageView: ImageView
    private val circularProgressDrawable: com.qiniu.qbaseframe.refresh.CircularProgressDrawable
