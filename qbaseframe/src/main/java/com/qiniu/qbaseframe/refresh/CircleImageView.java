...
class CircleImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int wh = MeasureSpec.makeMeasureSpec(size, MeasureSpec.EXACTLY);
...
//    }
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            ...
            canvas.drawCircle(viewWidth >> 1, viewHeight >> 1, viewWidth >> 1, mShadowPaint);
            canvas.drawCircle(viewWidth >> 1, viewHeight >> 1, (viewWidth >> 1) - mShadowRadius, paint);
        }

        private void updateRadialGradient(int diameter) {
            mRadialGradient = new RadialGradient(diameter >> 1, diameter >> 1,
